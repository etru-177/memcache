...
export LD_LIBRARY_PATH=$MOCK_SMEM_LIB_PATH:$MEMCACHE_LIB_PATH:$SMEM_LIB_PATH:$HYBM_LIB_PATH:$MOCK_CANN_PATH/driver/lib64:$MOCK_MMC_UBSIO_PATH:$MOCK_MMC_CANN_PATH:$LD_LIBRARY_PATH
